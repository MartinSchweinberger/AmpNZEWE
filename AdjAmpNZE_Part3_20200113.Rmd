...
We retain Age because it is significant. We continue by adding Frequency.
...
Although including Frequency does not lead to substantial collinearity (vifs > 5), we do not retain it in the model because it is not significant. We continue by adding Emotionality.
...
Including Emotionality does not lead to substantial collinearity (vifs > 5) and we retain it in the model because it is significant. We proceed with adding Ethnicity.
...
Including Ethnicity does not lead to substantial collinearity (vifs > 5) but we do not retain it in the model because it is not significant. We proceed with adding SemanticCategory.
